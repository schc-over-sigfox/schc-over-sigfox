...
class TestSCHCReceiver(TestCase):
    ...
    def test_fragment_is_receivable(self):
        ...
        header = FragmentHeader(profile, '', '00', '110')
        f = Fragment(header, b'\x1a\x2b\x3c\x4d')
        all_1 = Fragment(FragmentHeader(profile, '', '11', '111', '001'),
                         b'\x1a\x2b\x3c\x4d')
        ...
        last_fragment = Fragment(FragmentHeader(profile, '', '01', '011'),
                                 b'\x1a\x2b\x3c\x4d')
    ...
    def test_get_pending_ack(self):
        ...
        all_1 = Fragment(FragmentHeader(profile, '', '11', '111', '001'),
                         b'\x1a\x2b\x3c\x4d')
        fragment = Fragment(FragmentHeader(profile, '', '01', '101'),
                            b'\x1a\x2b\x3c\x4d')
        complete_ack = CompoundACK(profile, '', ['11'], '1', ['0000000'])
    ...
    def test_update_bitmap(self):
        ...
        fragment = Fragment(FragmentHeader(profile, '', '01', '100'),
                            b'\x1a\x2b\x3c\x4d')
    ...
    def test_fragment_was_already_received(self):
        ...
        all_0 = Fragment(FragmentHeader(profile, '', '01', '000'),
                         b'\x1a\x2b\x3c\x4d')
        self.assertFalse(receiver.fragment_was_already_received(all_0))
        all_1 = Fragment(FragmentHeader(profile, '', '10', '111', '111'),
                         b'\x1a\x2b\x3c\x4d')
    ...
    def test_generate_compound_ack(self):
        ...
        fragment = Fragment(FragmentHeader(profile, '', '01', '000'),
                            b'\x1a\x2b\x3c\x4d')
        ...
        all_1 = Fragment(FragmentHeader(profile, '', '10', '111', '011'),
                         b'\x1a\x2b\x3c\x4d')
        ack = receiver.generate_compound_ack(all_1)
    ...
    def test_schc_recv(self):
        ...
        complete_ack = CompoundACK(profile, '', ['11'], '1', ['0000000'])
        all_1 = Fragment(FragmentHeader(profile, '', '01', '111', '001'),
                         b'\x1a\x2b')
        receiver.STORAGE.JSON = {
            'simulator': {
                '1a2b3c': {
