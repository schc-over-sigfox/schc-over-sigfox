...
class Fragmenter:
    ...
    def generate_fragment(self, payload: bytes, all_1: bool) -> Fragment:
        ...
        w = int_to_bin(
            floor(
                self.CURRENT_FRAGMENT_NUMBER / self.PROFILE.WINDOW_SIZE % number_of_windows),
            self.PROFILE.M
        )
        dtag = ''
        ...
        self.CURRENT_FRAGMENT_NUMBER = (
                                                   self.CURRENT_FRAGMENT_NUMBER + 1) % self.PROFILE.MAX_FRAGMENT_NUMBER
